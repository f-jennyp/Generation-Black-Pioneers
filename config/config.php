<?php
	...
	$siteInfo= [
			//general info
			"company_name" => "Generational Black Pioneers", 
			"phone" =>  "123-456-7890", 		  //either no format or dashed format
			"email" => "info@generationalblackpioneers.com",   //by default is used as recipient email  
			"address" => "301 Mission Avenue Oceanside CA 92054 unit 101A", 
